...
public class Game {
    ...
    public void start() {
        ...
        System.out.println("All targets are down. I repeat all targets are down. " + sniperRifle.getShootsFired() + " shots.");
    ...
    private GameObject[] createGameObjects(int numberObjects) {
        ...
        for (int i = 0; i <gameObjects.length ; i++) {
            ...
            gameObjects[i] = Math.random() < ENEMIE_PROBABILITY ? GameObjectFactory.createEnemy() : GameObjectFactory.createObject();
